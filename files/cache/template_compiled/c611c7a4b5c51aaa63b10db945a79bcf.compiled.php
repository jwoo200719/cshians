	...
	<div class="x_control-group">
		...
		<div class="x_controls">
			<select name="password_hashing_algorithm" id="password_hashing_algorithm" style="width:auto">
				<?php if($__Context->password_hashing_algos&&count($__Context->password_hashing_algos))foreach($__Context->password_hashing_algos as $__Context->key=>$__Context->val){ ?><option value="<?php echo $__Context->key ?>"<?php if($__Context->config->password_hashing_algorithm==$__Context->key){ ?> selected="selected"<?php } ?>><?php echo $__Context->val ?></option><?php } ?>
			</select>
