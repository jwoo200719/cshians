<?php if(!defined("__XE__"))exit;?><div style="background-image:url('<?php echo $__Context->layout_info->path ?>img/slider_img.jpg');" class="swiper-slide">
	<div>
		<div>
			<h1>CSHians - BBS for CSHS</h1>
			<p>지식을 나누고 공유하는 커뮤니티 서비스입니다.</p>
		</div>
	</div>
</div>
...
<div style="background-image:url('<?php echo $__Context->layout_info->path ?>img/slider_img4.jpg');" class="swiper-slide">
	<div>
		<div>
