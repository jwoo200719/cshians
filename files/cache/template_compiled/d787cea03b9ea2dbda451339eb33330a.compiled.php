...
<div class="welcomeXE">
	...
	<section class="guide">
		...
		<li>
			...
			<h2>레이아웃 디자인 바꾸기</h2>
			<p>XE는 다양한 레이아웃 디자인을 제공합니다. 레이아웃 디자인은 <a href="<?php echo getUrl('', 'module', 'admin', 'act', 'dispMenuAdminSiteDesign') ?>" target="_blank">[관리 &gt; 사이트 제작/편집 &gt; 사이트 디자인 설정]</a>에서 변경할 수 있습니다.</p>
		</li>
		<li>
